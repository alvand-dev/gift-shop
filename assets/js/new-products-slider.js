...
{
  // Get HTML elements
  const sliderList = document.querySelector("#new-products .slider-list");
  const sliderItems = document.querySelectorAll("#new-products .slider-item");
  const sliderNext = document.querySelector("#new-products .slider-arrow-next");
  const sliderPrev = document.querySelector("#new-products .slider-arrow-prev");
