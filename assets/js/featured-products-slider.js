...
// Get HTML elements
const sliderList = document.querySelector('#featured-products .slider-list');
const sliderItems = document.querySelectorAll('#featured-products .slider-item');
const sliderNext = document.querySelector('#featured-products .slider-arrow-next');
const sliderPrev = document.querySelector('#featured-products .slider-arrow-prev');
